    ...
    textarea.addEventListener(
        ...
        async function a(e){
            if(e.key == "Enter"){
                ...
                let req = `Considerando esta lista de produtos ${JSON.stringify(products)}, retorne o maior número de IDs que satisfaçam da melhor maneira o seguinte pedido ${e.target.value}, considerando que você é um cliente procurando por produtos em uma loja online. Sua resposta deve ser no formato "ID,ID,ID", sem nenhum outro conteúdo nela.`
